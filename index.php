...
<div id="recent-posts">
	<h2>Explanation</h2><br />
        ...
        <div id="latest-post" class="post" >
            <h2>Updates</h2>
            <table class="table_update table_center">
                <tbody>
                    <tr>
                        <td class="update_date">October 18th, 2009:</td>
                        <td class="update_news">Added the ability to have Random Names! If the name isn\'t given directly, a name will be generated. SuhhhWEET!</span></td>
                     </tr>
                    <tr>
                        <td class="update_date">October 17th, 2009:</td>
                        <td class="update_news">Added Printable page for a generated city to make saving your generated masterpiece savable</span></td>
                     </tr>
                    <tr>
                        <td class="update_date">October 15th, 2009:</td>
                        <td class="update_news">Added import and export commodities, psionics class, specific power center titles, and famous/infamous associated with each city! KOW-A-BUNGA! <span class="italic">(All excellent ideas donated by Nijineko)</span></td>
                    </tr>
                    <tr>
                        <td class="update_date">October 8th, 2009:</td>
                        <td class="update_news">Site is launched! YAY!</td>
                    </tr>
                </tbody>
            </table>
        <br />
