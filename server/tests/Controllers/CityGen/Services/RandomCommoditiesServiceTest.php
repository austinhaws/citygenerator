...
final class RandomCommoditiesServiceTest extends BaseTestCase
{
    ...
    public function testRandomCommodities()
    {
        ...
        $this->services->random->setRolls([
            ...
            new TestRoll('Commodity', 4, 1, 3700),
            new TestRoll('Commodity', 5, 1, 3700),
            new TestRoll('Commodity', 550, 1, 3700),
            new TestRoll('Commodity', 4, 1, 3700),
            new TestRoll('Commodity', 20, 1, 3700),
            new TestRoll('Commodity', 3700, 1, 3700),
            new TestRoll('Number Imports', 3, 2, 4),
            new TestRoll('Commodity', 3300, 1, 3700),
            new TestRoll('Commodity', 3300, 1, 3700),
            new TestRoll('Commodity', 200, 1, 3700),
            new TestRoll('Commodity', 3300, 1, 3700),
            new TestRoll('Commodity', 3300, 1, 3700),
            new TestRoll('Commodity', 3300, 1, 3700),
            new TestRoll('Commodity', 3300, 1, 3700),
            new TestRoll('Commodity', 400, 1, 3700),
        ]);
