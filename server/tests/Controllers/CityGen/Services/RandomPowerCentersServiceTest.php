...
final class RandomPowerCentersServiceTest extends BaseTestCase
{
    ...
    public function testDeterminePowerCentersLots()
    {
        ...
        $this->services->random->setRolls([
            ...
            new TestRoll('Power Center Type', 250, 1, 1000),
            new TestRoll('Influence', 84, 84, 103),
            new TestRoll('Power Center Alignment', 10, 1, 100),
            new TestRoll('NPC Class', 999, 1, 1000),
            ...
            new TestRoll('NPC Class', 700, 1, 1000),
            new TestRoll('NPC level bonus', 1, 0, 1),
            ...
            new TestRoll('Power Center Type', 750, 1, 1000),
            new TestRoll('Influence', 90, 84, 103),
            new TestRoll('Power Center Alignment', 85, 1, 100),
            new TestRoll('NPC Class', 663, 1, 1000),
            ...
            new TestRoll('NPC Class', 597, 1, 1000),
            new TestRoll('NPC level bonus', 1, 0, 1),
            ...
            new TestRoll('Power Center Type', 449, 1, 1000),
            new TestRoll('Influence', 17, 84, 103),
            new TestRoll('Power Center Alignment', 62, 1, 100),
            new TestRoll('NPC Class', 478, 1, 1000),
            new TestRoll('NPC level bonus', 1, 0, 1),
            new TestRoll('NPC level', 7, 1, 20),
            new TestRoll('NPC Level Increase', 10, 1, 10),
            new TestRoll('NPC Level Increase', 10, 1, 10),
            ...
            new TestRoll('NPC Class', 222, 1, 1000),
            new TestRoll('NPC level bonus', 1, 0, 1),
